...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.simplifysynergy.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.simplifysynergy.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
