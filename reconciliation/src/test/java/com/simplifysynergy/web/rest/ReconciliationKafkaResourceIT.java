...
@WithMockUser
@EmbeddedKafka
class ReconciliationKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/reconciliation-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/reconciliation-kafka/consume")
