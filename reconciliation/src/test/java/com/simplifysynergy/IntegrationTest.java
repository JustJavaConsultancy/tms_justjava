...
import com.simplifysynergy.ReconciliationApp;
import com.simplifysynergy.config.AsyncSyncConfiguration;
import com.simplifysynergy.config.EmbeddedKafka;
import com.simplifysynergy.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ReconciliationApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
@EmbeddedKafka
